...
const cardData = [
  ...
  "/images/muntirent7.png"],
    description: "Munti Rent: Finder is a mobile app platform that allows landlords to post their properties and tenants to easily rent them. The app features an AI-powered search engine and a chatbot to help users find suitable properties and answer questions instantly.",
    tools: ["Kotlin", "XML", "Python (Fast API)", "Gemini Ai", "Hugging Face","FAISS", "NumPy", "MySQL"]
  },
  {
  ...
  "/images/SmartAiFireMonitoring9.png",
    ...
    description: "Smart AI-Based Fire Monitoring – A mobile app connected to IoT sensors that monitors fire, temperature, smoke, and humidity. It sends instant notifications via FCM when hazards are detected, triggers AI voice alerts, and includes a chatbot for user interaction.",
    tools: ["Java", "Python", "ESP32", "DHT22", "MQ2 Smoke Snesor", "KYS026 Flame Sensor", "Firebase", "Gemini Ai", "Eleven Labs Ai"]
  },
  {
  ...
  "/images/deaf17.png"
    ...
    description: "A real-time sign language practice platform where students can learn and practice using AI-powered hand gesture recognition. Teachers can upload learning materials, and students can follow along and practice interactively.",
    tools: ["Python (FastApi)", "Numpy", "OpenCV", "HTML5", "Bootstrap", "Javascript", "MySQL"]
  },
  {
